...
//void run(const oatpp::base::CommandLineArguments& args) {
    ...
    try {
        ...
        oatpp::Environment::Component<std::shared_ptr<boost::asio::io_context>> io_context = ioc;
        oatpp::Environment::Component<std::shared_ptr<boost::asio::executor_work_guard<boost::asio::io_context::executor_type>>> workgurdenv = workGuard;
